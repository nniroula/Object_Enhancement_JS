...
/* Write an ES2015 Version */
let favoriteNumberTwo = 42;
let isntructor = {
    firstName: "Colt",
    [favoriteNumberTwo]: "That is my favorite"
}
...
function createAnimal(species, verb, noise){
    ...
    return {
        //species: species
        species,
        // when verb is called return noise
        [verb](){         // verb not simply a function, it has to be a key-so put it in []
            return noise;
        }
    }
}
